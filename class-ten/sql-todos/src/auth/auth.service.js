...
export const register = async ( user ) =>
{
    ...
    if ( existingUserWithEmail ) throw new Error( "This email has been taken" );
...
export const login = async ( user ) =>
{
    ...
    if ( !existingUser ) throw new Error( "Invalid credentials, please check your input and try again" );

    if ( !await bcrypt.compare( user.password, existingUser.password ) ) throw new Error( "Invalid credentials, please check your input and try again" );
